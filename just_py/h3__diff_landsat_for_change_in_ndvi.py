...
def udf(bounds: fused.types.Bounds= None,
        first_years:list = [1991, 1992],  # Multiple years
        second_years:list = [2020, 2021],
       res:int=7,
        cloud_threshold=10,
        stats_type:str="mean",
    ...
    first_time_periods = [f"{year}-04-01/{year}-09-30" for year in first_years]
    second_time_periods = [f"{year}-04-01/{year}-09-30" for year in second_years]
...
def get_df_latlng(bounds,evi, cloud_threshold, first_time_periods, second_time_periods):
    import pandas as pd
    common = fused.load("https://github.com/fusedio/udfs/tree/b7637ee/public/common/")
    landsat_vector = "fsh_2gd8h5CAr5LKmb0B3XMCyB"
