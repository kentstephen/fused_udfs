...
def udf(
    ...
    df = df[df["level2_category_name"].str.contains("Hospital", case=False, na=False)]

    gdf_tract = gpd.read_file('https://www2.census.gov/geo/tiger/TIGER2020PL/STATE/30_MONTANA/30/tl_2020_30_tract10.zip')
