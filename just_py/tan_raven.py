...
def udf(bounds: fused.types.Bounds,
    ...
    import pandas as pd
    from utils import get_over, run_query, CMAP, add_rgb_cmap
    ...
    df_buildings = get_over(bounds, overture_type="land_use")
   # df_places = get_over(bounds, overture_type="place")
    ...
    x, y, z = tile.iloc[0][["x", "y", "z"]]
    print(x, y, z)
    df_dem = fused.run("fsh_1H94I6GfoY6n4yBNGK3vlV", x=x, y=y, z=z)
    print(df_dem)
    # print(df)
