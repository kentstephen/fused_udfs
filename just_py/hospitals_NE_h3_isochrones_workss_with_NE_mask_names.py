@fused.udf
def udf(bbox: fused.types.TileGDF=None, n: int=10, path:str="s3://fused-users/stephenkentdata/hospitals_NEW_ENG_r_8_iso_names.parquet"):
    ...
    def run_query(df_iso, df_kontur_us, mask_wkt):
        ...
        select 
            ...
            COALESCE(i.cnt,0) as hospital_density,
            COALESCE(k_us.pop, 0) as population,
            COALESCE(i.names, NULL) as hospital_names
