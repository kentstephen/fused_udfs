...
def udf(bounds: fused.types.Bounds=None, 
        time_of_interest="2022-02-15/2022-04-28", 
        chip_len:int=256, 
        scale:float=0.07,
       h3_size: int = 11):
    ...
    df = df_to_hex(bounds_values, df, data_cols=data_cols, h3_size=h3_size, hex_col='hex', return_avg_lalng=True)
    print(df)
    ...
    # df_dem = fused.run("fsh_5FZlHaVg8BqL2Eh2KTWevp", bounds=tile, h3_size=h3_size) # hexify
    # print(df_dem['hex'])
