@fused.udf
def udf(bounds: fused.types.Bounds=[-77.083,38.804,-76.969,38.983], time_of_interest="2025-09-01/2025-12-30", chip_len:int=256, scale:float=0.081):
    ...
    arr = get_arr(tile, time_of_interest=time_of_interest, output_shape=(chip_len, chip_len), max_items=100)
    ...
    zoom = tile.z[0]
    h3_size = min(int(3+zoom/1.43),15)
    print(h3_size) 
...
def get_arr(
    ...
    greenest_example = fused.load("Satellite_Greenest_Pixel_for_landsat_timelapse_2_october_31_2027")
