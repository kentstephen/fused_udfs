...
def udf(bounds: fused.types.Bounds=None, 
    ...
    df = run(tile, wbt_args, out_tif_name, extra_input_files=None, min_max=min_max, res=res)
    # arr = arr.sqeeze()
    ...
    df_dem = fused.run("fsh_4IVyYEyBoN5sOMdN41LfZr", bounds=bounds, res=res) # USGS dem_10meter_tile_hex_2
    # print(df_dem['hex'])
