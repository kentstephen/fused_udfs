...
def udf(bounds: fused.types.Bounds = None,  
        time_of_interest="2020-01-01/2022-12-30",
        h3_size:int=14,
       scale:float=0.057):
        import pandas as pd
        ...
        df_sentinel = fused.run("fsh_1vnVmes83NrONAW5J1dqXr",bounds=bounds, time_of_interest=time_of_interest, h3_size=h3_size,scale=scale)
