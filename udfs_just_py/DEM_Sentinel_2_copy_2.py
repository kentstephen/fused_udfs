...
def udf(bounds: fused.types.Bounds=None, 
          time_of_interest="2024-06-01/2024-09-15", 
        chip_len:int=768, 
         scale:float=0.0471,
       h3_size:int = 10):    
    ...
    arr = udf_sentinel.utils.get_arr(tile, time_of_interest=time_of_interest, output_shape=(chip_len, chip_len), max_items=15000)
    if arr is None:
        return
    ...
    # df_dem = fused.run("fsh_1H94I6GfoY6n4yBNGK3vlV", bounds=bounds, h3_size=h3_size)
