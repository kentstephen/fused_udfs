...
def udf(bounds: fused.types.Bounds = None,
    ...
    import rioxarray
    # file_paths = [
    # 'gs://fused-fd-stephenkentdata/stephenkentdata/stephenkentdata/snake_river_wy_1m_dem/USGS_1M_12_x52y485_WY_GrandTetonNP_D22.tif',
    # 'gs://fused-fd-stephenkentdata/stephenkentdata/stephenkentdata/snake_river_wy_1m_dem/USGS_1M_12_x52y484_WY_GrandTetonNP_D22.tif'
    # ]

    # List of the DEM files to process

    df = hexagons(res, file_paths, stats_type, bounds)
    return df
