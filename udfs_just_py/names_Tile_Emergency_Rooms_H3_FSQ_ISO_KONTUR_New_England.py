@fused.udf
def udf(bbox: fused.types.TileGDF=None, resolution: int=8, path:str="s3://fused-users/stephenkentdata/emergency_rooms_NEW_ENG_r_8_iso_names.parquet"):
    ...
    def run_query(df_iso, df_kontur_us, mask_wkt):
        ...
        select 
            ...
            AVG(COALESCE(i.cnt, 0)) as cnt,
            SUM(COALESCE(k_us.pop, 0)) as pop,
            string_agg(names, ', ') as names
