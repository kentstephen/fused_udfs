...
@fused.cache
def get_points(bbox, point_type):
    # Pull the points
    ...
    return category_dict.get(point_type, gpd.GeoDataFrame(geometry=[], crs="EPSG:4326"))
...
def get_iso_gdf(costing, time_steps, point_type): 
    # Greater Bushwick
