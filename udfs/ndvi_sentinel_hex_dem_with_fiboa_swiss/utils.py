...
def get_fields(bounds):
    gdf = fused.run("fsh_6cOfhwzXwxYj3d8rTjJaDD", bounds=bounds) #switzerland
...
def run_query(df_fiboa, df_sentinel, res, bounds):
...
inner JOIN 
  fields_to_cells f ON s.hex = f.hex
