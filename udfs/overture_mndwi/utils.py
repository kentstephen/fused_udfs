...
def get_over(tile, overture_type):
    ...
    gdf = fused.utils.Overture_Maps_Example.get_overture(tile, overture_type=overture_type, min_zoom=0)
...
def run_query(df_mndwi, df_building, res, bounds):
