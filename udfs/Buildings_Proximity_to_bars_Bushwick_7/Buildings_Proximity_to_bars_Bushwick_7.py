...
def udf(bbox: fused.types.TileGDF=None, 
    ...
    import pandas as pd
    from utils import get_iso_gdf, iso_to_h3, bushwick_boundary
    
    # This pulls 5 minute walking isochrones around FSQ coffee shops
    gdf_iso = get_iso_gdf(costing=costing, time_steps=time_steps, point_type=point_type)
    ...
    gdf_h3 = iso_to_h3(df_iso, resolution)
