...
st.header("Vegetation Segmentation Example")
...
index_min, index_max = st.slider(
    "Morphological Kernel Size (odd number)",
    min_value=0.0, max_value=1.0, value=(0.1, 0.9), step=0.01
)
    ...
    <script>
      ...
      new DeckGL({{
        ...
        layers: [
          new TileLayer({{
            id: "base",
            data: "https://staging.fused.io/server/v1/realtime-shared/UDF_Vegetation_Segmentation/run/tiles/{{z}}/{{x}}/{{y}}?dtype_out_raster=png&index_min={index_min}&index_max={index_max}&index_method={index_method}&return_mask=False",
            maxZoom: 25,
            minZoom: 0,
          ...
          new TileLayer({{
            id: "data",
            data: "https://staging.fused.io/server/v1/realtime-shared/UDF_Vegetation_Segmentation/run/tiles/{{z}}/{{x}}/{{y}}?dtype_out_raster=png&index_min={index_min}&index_max={index_max}&index_method={index_method}&return_mask={mask}",
            maxZoom: 25,
            minZoom: 0,
