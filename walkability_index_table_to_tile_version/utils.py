...
def get_data():
    ...
    print(gdf)
    return gdf
@fused.cache(path="s3://fused-users/stephenkentdata/fused-cache/stephen.kent.data@gmail.com/walkability_index_2/")
def get_walk_data():
    import pandas as pd
    ...
    gdf["walk_score"] = gdf["NatWalkInd"]
    gdf = gdf[["geometry", "walk_score"]]
    return gdf
